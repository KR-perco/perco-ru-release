...
echo '<div style="font-size: 32px; color: green;">Было удалено: <b>' . $accumulator / 1024 . ' гб</b></div>';
echo '<div style="font-size: 32px; color: green;">Было удалено: <b>' . $i . ' файлов</b></div>';
