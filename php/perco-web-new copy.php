        ...
        <div style="flex-direction: column;">
            ...
            <div class="two_blocks">
                <div class="left_text">
                    ...
                    <p>Контроллеры PERCo нового поколения имеют встроенную память с предустановленным программным обеспечением PERCo-Web и позволяют создать систему контроля и управления доступом без выделенного сервера. В таком режиме в разворачивании сервера на ПК нет необходимости, это позволяет снизить трудозатраты на обслуживание сервера и запуск системы в целом.</p>
                </div>
