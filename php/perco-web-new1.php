        ...
        <div style="flex-direction: column;">
            ...
            <div class="two_blocks">
                ...
                <div class="text">
                    ...
                    <ul>
                        <li>
                            <strong>Биометрия.</strong> Для организации контроля доступа при помощи биометрических данных применяется идентификация по отпечаткам пальцев, рисунку ладони и <a href="/products/terminaly-raspoznavaniya-lits/">распознавание лиц</a>.
                        </li>
                        <li>
                            <strong>Карты доступа.</strong> Могут использоваться карты доступа формата EMM/HID (125 кГц), Mifare (13,56 МГц) в том числе с защитой от копирования.
                        </li>
                        <li>
                            <strong>Мобильный доступ.</strong> Смартфон c NFC-модулем может использоваться как в качестве идентификатора, так и в качестве регистрирующего устройства. На смартфон необходимо установить бесплатное приложение PERCo Доступ или PERCo Регистрация.
                        </li>
                        <li>
                            <strong>Банковские карты.</strong> В качестве идентификаторов могут использоваться банковские карты с технологией Paypass.
                        </li>
                        <li>
                            <strong>Штрих-код.</strong> Штрих-код может применяться в качестве гостевого идентификатора и для контроля прохода на объекты массового пребывания людей, в том числе в составе систем платного доступа.
                        </li>
                        <li>
                            <strong>Распознавание номеров.</strong>
                            В качестве идентификаторов на автотранспортной проходной могут применять регистрационные номера транспортных средств. Для распознавания регистрационных номеров автомобилей необходимо наличие модуля “Интеграция с TRASSIR".
                        </li>
                    </ul>
                    <h4></h4>
                    <p></p>
        ...
        <div id="horizontal_scroll">
            <ul id="scrollGallery">
                ...
                <li>
                    ...
                    <img alt="Создание учетных данных" src="/images/products/perco-web/slides/2-Sozdanie-uchetnyh-dannyh.jpg">
                    <div class="text-scroll-gallery">
                ...
                <li>
                    ...
                    <img alt="Просмотр учетных данных" src="/images/products/perco-web/slides/3-Prosmotr-uchetnyh-dannyh.jpg">
                    <div class="text-scroll-gallery">
                ...
                <li>
                    ...
                    <img alt="Занесение отпечатков пальцев" src="/images/products/perco-web/slides/5-Zanesenie-otpechatkov-palcev.jpg">
                    <div class="text-scroll-gallery">
                ...
                <li>
                    ...
                    <img alt="Занесение отпечатков пальцев" src="/images/products/perco-web/slides/6-Raspoznavanie-lic.jpg">
                    <div class="text-scroll-gallery">
                        <p class="lead">
                ...
                <li>
                    ...
                    <img alt=" " src="/images/products/perco-web/slides/7-Identifikaciya-po-shtrihkodu.jpg">
                    <div class="text-scroll-gallery">
                        <p class="lead">
                ...
                <li>
                    ...
                    <img alt=" " src="/images/products/perco-web/slides/7a---Dobavlenie-transportnogo-sredstva.jpg">
                    <div class="text-scroll-gallery">
                        <p class="lead">
                ...
                <li>
                    ...
                    <img alt="Дизайн пропусков" src="/images/products/perco-web/slides/8-Dizajn-propuskov.jpg">
                    <div class="text-scroll-gallery">
                        <p class="lead">
                ...
                <li>
                    ...
                    <img alt="Заказ пропуска" src="/images/products/perco-web/slides/10-Zakaz-propuska.jpg">
                    <div class="text-scroll-gallery">
                ...
                <li>
                    <!-- // 11a // --> 
                    <h3>Верификация</h3>
                    <img alt="Верификация" src="/images/products/perco-web/slides/11a-Verifikaciya-2-okna.jpg">
                    <div class="text-scroll-gallery">
                        <p class="lead">
                ...
                <li>
                    ...
                    <img alt="Отчет о доходах" src="/images/products/perco-web/slides/12-Otchet-o-prohodah.jpg">
                    <div class="text-scroll-gallery">
                ...
                <li>
                    ...
                    <img alt="Отчет о местонахождении" src="/images/products/perco-web/slides/13-Mestonahozhdenie.jpg">
                    <div class="text-scroll-gallery">
                ...
                <li>
                    ...
                    <img alt="Выданные идентификаторы" src="/images/products/perco-web/slides/14-Vydannye-identifikatory2.jpg">
                    <div class="text-scroll-gallery">
        ...
        <div class="col-table smaller">
            ...
            <table class="col-table-i">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p>Идентификация по распознаванию номеров автомобилей</p>
                        </td>
                    ...
                    <tr>
                        <td>
                            <p>Информация о транспортных средствах</p>
                        </td>
                    ...
                    <tr>
                        <td>
                            <p>Текстовые и графические документы (допуски, справки, разрешения)</p>
                        </td>
