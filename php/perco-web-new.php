                ...
                <div class="left">
                    ...
                    <div class="plus">
                        ...
                        <div>
                            ...
                            Программное обеспечение системы позволяет реализовывать многоуровневую верификацию. Например,на первом уровне осуществляется проверка прав доступа, затем необходимо последовательное получение подтверждений от пирометра и алкотестера. Документы из учетных данных сотрудников могут использоваться в качестве дополнительного подтверждения прав доступа. Например, для получения доступа на объект может осуществляться проверка допуска к работе, наличия медицинской справки или особого пропуска.
                        </div>
                    </div>
                    <div class="plus">
