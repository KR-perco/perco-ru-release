		...
		<div class="right">
			...
			<div id="virtual-tour-block">
				<div id="virtual-tour">
					<div id="tourDIV">
						<div id="panoDIV">
							<noscript>
								...
								<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="100%" height="100%" id="tour3data/test_tour">
									<param name="movie" value="tour3data/test_tour.swf"/>
									<param name="allowFullScreen" value="true"/>
									<!--[if !IE]>-->
									<object type="application/x-shockwave-flash" data="tour3data/test_tour.swf" width="100%" height="100%">
										<param name="movie" value="tour3data/test_tour.swf"/>
										<param name="allowFullScreen" value="true"/>
										<!--<![endif]-->
										<a href="http://www.adobe.com/go/getflash">
											<img src="http://www.adobe.com/images/shared/download_buttons/get_flash_player.gif" alt="Get Adobe Flash player to visualize the Virtual Tour : New Project"/>
										</a>
									<!--[if !IE]>-->
									</object>
									<!--<![endif]-->
					...
					<script type="text/javascript" src="tour3data/test_tour.js"></script>
