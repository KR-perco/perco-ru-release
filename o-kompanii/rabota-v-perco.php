	...
	<div id="vacancies">
		<div>
			...
			<ul>
				...
				<li>Менеджеров по ВЭД</li>
				<li>Программистов 1С</li> 
			</ul>
		</div>
		<div>
			...
			<ul>
				...
				<li>Монтажников радиоэлектронной аппаратуры и приборов</li>
				<li>Операторов листогибочных прессов и учеников операторов листогибочного пресса</li>
				<li>Подготовителей металлоконструкций к покраске</li> 
				<li>Подсобных рабочих</li>
				<li>Слесарей-ремонтников</li>
