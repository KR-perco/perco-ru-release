	...
	<ul id="slider">
		...
		<li>
			<a href="/resheniya/sportivno-razvlekatelnye-obekty/">
				...
				<div class="banner_image" style="background-image: url(/images/banners/solution-sport-3.v2.jpg);"></div>
			</a>
		</li>
	</ul>
</div>
<div id="state_banner">
	<a class="b_items" href="/o-kompanii/">
		<div class="b_item">
			<div class="fon_img">
				<img width="120" height="45" alt="Продажи в <?=$country_company;?> странах мира" src="/images/icons/map.svg" />
				<span class="text_on_map"><?=$country_company;?></span>
			</div>
			<p>Продажи в <?=$country_company;?><br />странах мира</p>
		</div>
		<div class="b_item">
				<img width="120" height="45" alt="Современный завод систем безопасности" src="/images/icons/zavod.svg" />
			<p>Современный завод<br />систем безопасности</p>
		</div>
		<div class="b_item">
			<div class="fon_img">
				<img width="120" height="45" alt="<?=$year_company;?> работы на рынке" src="/images/icons/years.svg" />
	...
	<div class="about_content">
		...
		<div class="tabs">
			...
			<div>
				...
				<p>Высокое качество обеспечило продукции PERCo признание как в России, так и за рубежом – товары PERCo экспортируются в <?=$country_company;?> страну мира.</p>
