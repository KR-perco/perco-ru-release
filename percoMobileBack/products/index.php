...
$managerBlock = '<div class="workers-block">
                  ...
                  <a href="/percoMobileBack/offline/gallery.html">
                    <div class="">
                      <img src="bxlocal://section-galery.png" alt="photogallery">
                      <p>Фотогалерея</p>
                    </div>
                  </a>
                  <a href="/percoMobileBack/offline/booklets.html">
                    <div class="">
                      <img src="bxlocal://section-booklets.png" alt="booklets">
                      <p>Каталоги и буклеты</p>
                    </div>
                  </a>
                  <a href="/percoMobileBack/video/?worker=manager">
                    <div class="">
...
$installerBlock = '<div class="workers-block">
                <a href="/percoMobileBack/new/">
                  <div class="">
                    <img src="bxlocal://section-new.png" alt="new" />
                    <p>Новое</p>
                  </div>
                </a>
                <a href="/percoMobileBack/video/?worker=installer">
                  <div class="">
                    <img src="bxlocal://section-video.png" alt="video" />
                    <p>Видео</p>
                  </div>
                </a>
                <a href="/percoMobileBack/offline/faq.html">
                  <div class="">
                    <img src="bxlocal://section-faq.png" alt="faq" />
                    <p>FAQ</p>
                  </div>
                </a>
                <a href="/percoMobileBack/documentation/">
                  <div class="">
...
?>
    <div class="item">
      <a href="/percoMobileBack/products/<?=$arSection["CODE"];?>/?<?=$url["query"]?>">
        <?if ($img != 'dop-oborudovanie.'):?><img alt="<?=$arSection["NAME"];?>" src="bxlocal://catalog-<?=$img?>png" /><?else:?><img alt="<?=$arSection["NAME"];?>" src="/percoMobileBack/img/catalog-dop-oborudovanie.png" /><?endif;?>
