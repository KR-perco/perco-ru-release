...
if(CModule::IncludeModule("iblock"))
{
	...
	{
		$rsSection = CIBlockSection::GetList(array("SORT" => "ASC"), array("ACTIVE" => "Y", "IBLOCK_TYPE" => "video", "IBLOCK_ID" => $ar["IBLOCK_ID"], "SECTION_ID" => $ar["ID"], "UF_WORKER" => "manager"), false, array("UF_ARCHIVE"));
