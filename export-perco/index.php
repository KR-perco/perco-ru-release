...
$APPLICATION->SetTitle("Export PERCo");
?>
<!DOCTYPE html>
...
<link rel="stylesheet" href="/export-perco/css/export.css">

	<script type="text/javascript" src="/export-perco/js/jquery.min.js"></script>
	<script type="text/javascript" src="/export-perco/js/download.js"></script>
...
<div id="content">
	<div id="himg">
		...
		<img alt="" src="/images/icons/partneram.svg" />
	</div>
	<div><pre style="display: none;"><?var_dump($arParams["SECTION_USER_FIELDS"]);?></pre>
		<?
			...
			// echo'<pre>';
			// print_r($arParams);
			// echo $arParams["SECTION_USER_FIELDS"];
			// echo'</pre>';
		?>
	</div>
</div>