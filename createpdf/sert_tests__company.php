...
function createSert($ID, $txt, $datecomp, $sert_pole, $logoFile, $sert, $textColour)	// ID пользователя, текст, дата, поле сертификата, шаблон, тип сертификата
{
	...
	$pdf->SetFont('FuturaNew', '', 22);	// Устанавливаем шрифт
	...
	if ($sert == "adsc")
		...
		$pdf->SetXY(25, 96);	// Устанавливаем координаты
	...
	$fille = CFile::SaveFile($arFields, "tests-company-serts");
