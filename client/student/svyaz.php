...
$APPLICATION->AddChainItem("Связь с преподавателем", "");
$APPLICATION->SetPageProperty("title", "Связь с преподавателем");
$APPLICATION->SetPageProperty("keywords", "");
$APPLICATION->SetPageProperty("description", "");
$APPLICATION->SetTitle("Связь с преподавателем");
?>
<div class="dop_menu">
...
<?$APPLICATION->IncludeComponent("bitrix:support.ticket", "", Array(
	...
	"SEF_FOLDER" => "/client/student/svyaz.php",
