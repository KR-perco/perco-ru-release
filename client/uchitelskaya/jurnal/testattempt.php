...
if (CModule::IncludeModule("learning")){
    ...
    {
		echo '<p><a href="/client/uchitelskaya/">Вернуться к выбору Учащегося</a> | <a href="kursi.php?STUDENT_ID='.$arAttempt["STUDENT_ID"].'">Вернуться к выбору Экзамена</a> | <a href="popytki-uchawegosya.php?TEST_ID='.$arAttempt["TEST_ID"].'&STUDENT_ID='.$arAttempt["STUDENT_ID"].'">Вернуться к выбору попытки</a></p>';
