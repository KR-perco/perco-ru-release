...
$APPLICATION->AddChainItem("Регистрация на онлайн-семинар", "");
$APPLICATION->SetPageProperty("title", "Регистрация на онлайн-семинар | PERCo");
$APPLICATION->SetPageProperty("description", "Форма для регистрации на онлайн-семинар");
$APPLICATION->SetPageProperty("keywords", "");
$APPLICATION->SetTitle("Регистрация на онлайн-семинар");
...
<div id="content">
	...
	<p><a href="/obuchenie/installyatorov/online-seminary.php">Вернуться к списку семинаров</a></p>
<?
