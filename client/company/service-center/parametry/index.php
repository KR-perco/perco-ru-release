...
?>
	<form enctype="multipart/form-data" method="POST" action="<?$_SERVER["PHP_SELF"]?>" name="PSO">
		<table class="data-table" cellpadding="3" border="0" cellsapcing="0"> 
			<tr>
				<th>№</th>
			...
			<tr>
				...
				<td>час</td>
				<td><input type="text" size="45" value="<?=$vrnpo;?>" name="form_vrnpo" class="inputtext"></td>
			</tr>
			<tr>
				<td>2</td>
				<td>Время выезда на объект</td>
				<td>час</td>
				<td><input type="text" size="45" value="<?=$vvno;?>" name="form_vvno" class="inputtext"></td>
			</tr>
			<tr>
				<td>3</td>
				<td>Время устранения неисправности</td>
				<td>час</td>
				<td><input type="text" size="45" value="<?=$vun;?>" name="form_vun" class="inputtext"></td>
			</tr>
			<tr>
				<td>4</td>
				<td>Стоимость выезда на объект</td>
				<td>рублей</td>
				<td><input type="text" size="45" value="<?=$svno;?>" name="form_svno" class="inputtext"></td>
			</tr>
			<tr>
				<td>5</td>
				<td>Стоимость нормочаса работы на объекте</td>
				<td>рублей</td>
				<td><input type="text" size="45" value="<?=$snchrno;?>" name="form_snchrno" class="inputtext"></td>
			</tr>
		</table>
