...
if (CModule::IncludeModule("learning"))
{
	...
	$PORITKA_ID=$_GET["POPITKA_ID"];
	$res = CTestAttempt::GetByID($POPITKA_ID);
    if ($arAttempt = $res->GetNext())
    {
		echo '<p><a href="/client/prepodavatelskaya/">Вернуться к выбору Учащегося</a> | <a href="kursi.php?STUDENT_ID='.$arAttempt["STUDENT_ID"].'">Вернуться к выбору Экзамена</a> | <a href="popytki-uchawegosya.php?TEST_ID='.$arAttempt["TEST_ID"].'&STUDENT_ID='.$arAttempt["STUDENT_ID"].'">Вернуться к выбору попытки</a></p>';
