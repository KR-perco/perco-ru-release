...
$items = array(
	array(
		"text" => "Каталог",
		"data-url" => SITE_DIR."percoDemo/products/",
		"id" => "products",
		"image"=>"img/menu-catalog.png",
	),
	array(
		"text" => "Видео",
		"data-url" => SITE_DIR."percoDemo/video/",
		"id"=>"video",
		"image"=>"img/menu-video.png",
	),
	array(
		"text" => "Скачать",
		//"data-url" => SITE_DIR."percoDemo/offline/documentation.html",
		"data-url" => SITE_DIR."percoDemo/documentation/",
		"id"=>"documentation",
	...
	array(
		"text" => "Контакты",
		"data-url" => SITE_DIR."percoDemo/offline/contacts.html",
		"id"=>"offline/contacts.html",
		"image"=>"img/menu-contacts.png",
	),
	array(
		"text" => "Написать",
		"data-url" => SITE_DIR."percoDemo/letter/",
		"id"=>"letter",
		"image"=>"img/menu-letter.png",
	),
	array(
		"text" => "О компании",
		"data-url" => SITE_DIR."percoDemo/about/",
		"id"=>"about",
		"image"=>"img/menu-about.png",
	),
	array(
		"text" => "О приложении",
		"data-url" => SITE_DIR."percoDemo/offline/app.html",
		"id"=>"offline/app.html",
