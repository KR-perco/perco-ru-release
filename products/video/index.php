...
$APPLICATION->SetPageProperty("title", 'Системы безопасности и контроля доступа PERCo - Видео продукции');
...
$APPLICATION->SetTitle('Системы безопасности и контроля доступа PERCo - Видео продукции');
...
<div id="content">
	...
	<?
	global $arrFilter;
	$arrFilter = array('UF_SECTION' => 'products');
