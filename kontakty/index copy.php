				...
				<div class="box-before">
					...
					<div class="tabs">
						...
						<div class="item" itemscope itemtype="http://schema.org/Organization">
							...
							<dl>
								<dd class="addres"><span><span
											itemprop="addressLocality">Нидерланды, Роттердам</span><br>
										<span itemprop="streetAddress">Ringdijk 374 - 378, 2983 GS Ridderkerk</span></span>
								</dd>
							</dl>
							<dl>
								<dd class="map">
									<a data-src="/kontakty/rotterdam.php?iframe=true&map=yandex" _map="yandex"
										title="Яндекс" data-iframe="true"><img
											src="/images/kontakty/yandex.svg"></a>
									<a data-src="/kontakty/rotterdam.php?iframe=true&map=google" _map="google"
										title="Google" data-iframe="true"><img
											src="/images/kontakty/google-maps-seeklogo.com.svg"></a>
								</dd>
							</dl>
				...
				<div class="box-before">
					...
					<dl>
						<dd class="bank-details">
							...
							р/сч 40702810880000006399<br>
							Филиал Удельный Банка ВТБ (ПАО)<br>в Санкт-Петербурге г. Санкт-Петербург<br>
							БИК 044030704 к/сч 30101810200000000704
						</dd>
					</dl>
					<dl>
						<dd>
