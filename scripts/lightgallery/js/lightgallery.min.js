...
! function (a, b, c, d) {
    ...
    e.prototype.init = function () {
        ...
        var q = !1;
        // console.log(l.$items.eq(c).attr("data-iframe"));
        l.s.dynamic ? l.s.dynamicEl[c].iframe && (q = !0) : "true" === l.$items.eq(c).attr("data-iframe") && (q = !0);
        var r = l.isVideo(g, c);
        if (!l.$slide.eq(c).hasClass("lg-loaded")) {
            
            if (q) {
                $('.lg').addClass('iframe-over');
                l.$slide.eq(c).prepend('<div class="lg-img-wrap"><iframe class="lg-object lg-image lg-iframe" frameborder="0" src="' + g + '"  allowfullscreen="false" style="width: 100%; height: 100%;"></iframe></div></div>');
            }
            else if (m) {
                var s = "";
