	...
	window.addEventListener('load', () => {
		const kronshteiny = [
			...
			},
			{
				...
				categories: [['Скоростной проход ST-01', 'Контроллер Suprema BioEntry W2 (P2)']],
				price: 63
			},
			{
				...
				categories: [['Тумбовый турникет TTD-03.1', 'Контроллер Suprema BioEntry W2 (P2)']],
				price: 49
			},
			{
				...
				categories: [['Скоростной проход ST-01', 'Контроллер PERCo-CL15']],
				price: 78
			},
			{
				name: 'Стойка BSP1',
			...
			},
			{
				...
				categories: [
					...
					['Электронная проходная KT02.3, KT02.9, KT02.9B, KT02.9Q', 'Терминал распознавания лиц ZKTeco-FaceDepot-7A'],
		...
		const combinations = {
			...
			'Электронная проходная KT02.3, KT02.9, KT02.9B, KT02.9Q': {
				'Терминал распознавания лиц ZKTeco-FaceDepot-7A': [
					{
						name: 'Решение для установки терминала распознавания лиц ZKTeco-FaceDepot-7A на электронные проходные KT02.3, KT02.9, KT02.9B, KT02.9Q',
