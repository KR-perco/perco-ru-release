    ...
    a.fn.lightSlider = function (b) {
        ...
        return z.chbreakpoint = function () {
            ...
            controls: function () {
                ...
                if (e.arrowsGray) {
                    $('.lSAction .lSPrev').css('background-image', 'url(/images/icons/arrow_grey.svg)');
                }
            },
            initialStyle: function () {
                // console.log('e.verticalHeight');
                // console.log(e.verticalHeight);
                // e.loop = false; //TODO
                var a = this;
            ...
            move: function (a, b) {
                // console.log(a + ',' + b);
                // console.log($('#lightSlider li.active .description').height());
                // debugger;
                ...
                this.active(c, !0)
                $('#lightSlider').height($('#lightSlider li.active .video-block').height());
            ...
            build: function () {
                ...
                if($('#lightSlider li.active .video-block').height()){
                    $('#lightSlider').height($('#lightSlider li.active .video-block').height());
                    // console.log($('#lightSlider li.active .video-block').height());
                }
            ...
            if (e.arrowsGray) {
                $('.lSAction .lSPrev').css('background-image', 'url(/images/icons/arrow.svg)');
                $('.lSAction .lSNext').css('background-image', 'url(/images/icons/arrow.svg)');
            }
            ...
            q * e.slideMove < l - e.slideMove && a ? (e.onBeforeNextSlide.call(this, g, q), q++, g.mode(!1), e.gallery === !0 && d.slideThumb()) : e.loop === !0 ? (e.onBeforeNextSlide.call(this, g, q), q = 0, g.mode(!1), e.gallery === !0 && d.slideThumb()) : e.slideEndAnimation === !0 && (g.addClass("rightEnd"), setTimeout(function () {
                ...
                if (e.arrowsGray) {
                    $('.lSAction .lSNext').css('background-image', 'url(/images/icons/arrow_grey.svg)');
                    $('.lSAction .lSPrev').css('background-image', 'url(/images/icons/arrow.svg)');
                }
            }, 0)) //400
        }, g.mode = function (a) {
