...
$(document).ready(function () {
	...
	// function collapsebox(id1, id2) {
	//     $(id1).toggleClass("collapse", 1000);
	//     $(id2).toggleClass("rotate", 1000);
	//     // console.log(id);
	...
	if (!window.elements) {
		...
		window.elements.set('#container h1', parseInt($("#container h1").css("font-size")));
		window.elements.set('#container h2', parseInt($("#container h2").css("font-size")));
		window.elements.set('#container h3', parseInt($("#container h3").css("font-size")));
		window.elements.set('#container p', parseInt($("#container p").css("font-size")));
		window.elements.set('#container ul', parseInt($("#container ul").css("font-size")));
	}
	...
	$('#up').click(function () {
		upSize(window.elements);
	});
	$('#down').click(function () {
		downSize(window.elements);
	});
	$('div.close').click(function () {
		$('div.sizer .yellow-box').toggleClass('act');
