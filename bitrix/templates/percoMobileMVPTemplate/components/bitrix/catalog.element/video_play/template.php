...
$APPLICATION->SetTitle($name.$dop_name);
?>
<h1><?$APPLICATION->ShowTitle(false, false)?></h1>
<div id="video_element">
	<video id="<?=$arResult["ID"];?>" controls="controls" autoplay="autoplay" poster="<?=$poster;?>">
...
<div class="dop_info">
	...
	<div><a href="<?=$file;?>" title="<?=$name;?>" <?=$google;?> download><?=GetMessage("DOWNLOAD")?></a> <?=$fSize;?> — <?=$date;?></div>
</div>