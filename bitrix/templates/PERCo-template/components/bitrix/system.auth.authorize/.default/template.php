...
<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
	...
	?>
<p style="padding:0; margin:0"><?=GetMessage("AUTH_PLEASE_AUTH")?></p>
<table style="padding:0 0 0 10px">
	<thead>
		<tr>
			<td colspan="2"><h3 style="padding:0;"><?=GetMessage("AUTH_AUTH")?></h3></td>
		</tr>
	</thead>
	<tbody>
		<tr>
...
{
	echo '<noindex><p><a rel="nofollow" href="?forgot_password=yes">Забыли свой пароль?</a></p></noindex>';
	echo '<noindex><p><a rel="nofollow" href="/client/registration/">Зарегистрироваться</a><br>Если Вы впервые на сайте, заполните, пожалуйста, регистрационную форму.</p></noindex>';
}
...
elseif ($USER->IsAuthorized())
{
	...
	$CUserInstance = new CUser;
	$arGroups = $CUserInstance->GetUserGroupArray();
