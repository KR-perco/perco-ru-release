...
<form id="getExport" name="Tree" action="ziped_data.php" method="POST">
	<div class="blocks">
		...
		<div>
			<h3>Sélectionnez les champs requis:</h3>
			<label class="container">Annonce
			...
			<label class="container">Caractéristiques
				<input type="checkbox" name="fields[]" value="characteristics">
				<span class="checkmark"></span>
			</label>

			<label class="container">Photo
				<input type="checkbox" name="fields[]" value="photo">
				<span class="checkmark"></span>
			</label>

			<label class="container">Schéma
				<input type="checkbox" name="fields[]" value="sheme">
				<span class="checkmark"></span>
			</label>

			<label class="container">Documents
				<input type="checkbox" name="fields[]" value="docs">
				<span class="checkmark"></span>
			</label>
			<div class="xls-check">	
				<label class="container">Besoin de fichier xls pour MS Excel
					<input type="checkbox" name="excel" value="true">
					<span class="checkmark"></span>
				</label>
			</div>
			<div class="act">
				<input type="submit" value="Collecter des données">
