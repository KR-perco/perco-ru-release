	...
	<div class="blocks">
		...
		function outTrees($arr) {
			foreach ($arr as $item){
				...
				if ($item['NAME'] == " Идентификаторы" ||  
				$item['NAME'] == "Дополнительное оборудование") { 
					// исключаем реализованные "идейно" картегории
				} else {
