...
<form id="getExport" name="Tree" action="ziped_data.php" method="POST">
	<div class="blocks">
		...
		<div>
			<h3>Wählen Sie die nötige Felder:</h3>
			<label class="container">Vorankündigung
				<input type="checkbox" name="fields[]" value="anouns" checked="checked">
				<span class="checkmark"></span>
			</label>
			<label class="container">Beschreibung, Einzelheiten
			...
			<label class="container">Charakteristiken
			...
			<label class="container">Schema
				<input type="checkbox" name="fields[]" value="sheme">
				<span class="checkmark"></span>
			</label>

			<label class="container">Dokumente
				<input type="checkbox" name="fields[]" value="docs">
				<span class="checkmark"></span>
			</label>
			<div class="xls-check">	
				<label class="container">Brauchen xls File für MS Excel
					<input type="checkbox" name="excel" value="true">
					<span class="checkmark"></span>
				</label>
			</div>
			<div class="act">
				<input type="submit" value="Daten erheben">
