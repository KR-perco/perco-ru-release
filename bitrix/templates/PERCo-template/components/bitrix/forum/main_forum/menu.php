...
?>
		...
		<span class="forum-menu-item forum-menu-messages-to-admin"><a href="/forum/?PAGE_NAME=pm_edit&FID=0&MID=0&UID=3033&mode=new"><span>Написать администратору</span></a>&nbsp;</span>
