	...
	<div class="forum-reply-fields">
		...
		<div class="forum-reply-field-user">
			<div class="forum-reply-field forum-reply-field-author">
				<? if ($arResult["POST_VALUES"]["USER_ID"] == "3033"){
						?><div>Кому: администратору <?=$arResult["POST_VALUES"]["SHOW_NAME"]["text"]?></div><?
					}
					else{
					?>
				<label for="input_USER_ID"><?=GetMessage("F_HEAD_TO")?><span class="forum-required-field">*</span></label>
			...
			<div class="forum-reply-field forum-reply-field-email" style="display: none"><br />
