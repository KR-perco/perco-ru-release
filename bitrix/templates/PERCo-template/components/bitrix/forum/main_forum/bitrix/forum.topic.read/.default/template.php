...
<div class="forum-header-box">
	<div class="forum-header-options" style="display: none">
<?
	...
	/*if ($USER->IsAuthorized())
	{
		...
		{
			?>&nbsp;&nbsp;<span style="display: none" class="forum-option-subscribe forum-option-do-unsubscribe"><noindex><a rel="nofollow" title="<?=GetMessage("F_UNSUBSCRIBE_TITLE")?>" href="<?
