...
?>
	<div class="secel_item test1">
		<a href="<?=str_ireplace("_com", "", $section["SECTION_PAGE_URL"]);?>">
			...
			if ($arSection["IBLOCK_ID"] == 64 && $arSection["ID"] == 25147) {
				echo '<div class="price">
			...
			if ($arSection["IBLOCK_ID"] == 64 && $arSection["ID"] == 25631) {
				echo '<div class="price">
			...
			if ($arSection["IBLOCK_ID"] == 64 && $arSection["ID"] == 25578) {
				echo '<div class="price">
			...
			if ($arSection["IBLOCK_ID"] == 64 && $arSection["ID"] == 25780) {
				echo '<div class="price">
