...
<?php else:?>
	...
	$arGradebookA = CGradebook::GetList(Array("ID" => "DESC"),Array("TEST_ID" => $arResult["TEST"]["ID"], "STUDENT_ID" => $STUDENT_ID));
...
?>
	...
	<form name="learn_test_answer" action="<?=$arResult["ACTION_PAGE"]?>" method="post">
		...
		&nbsp;&nbsp;&nbsp;
		<input type="button" onclick="question();" value="<?=GetMessage("LEARNING_BTN_FINISH")?>" />
