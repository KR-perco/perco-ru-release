			...
			if($sectionCount > 0 && $section["CODE"] != "identifikatory"){
				...
				if ($arParentSection = $rsParentSection->GetNext())
				{
					...
					while ($arSect = $rsSect->GetNext())
					{
						...
						?>
							...
							<div class="element">
								<a href="/percoMobile/products/<?=$arSect["CODE"]?>/">
				...
				if ($arResult["SECTION"]["CODE"] == "kompleksnaya-sistema-bezopasnosti-perco-s-20")
				{
					?>
						...
						<div class="element">
							<a href="/percoMobile/products/kontrollery-schityvateli/">
				...
				while($ob = $res->GetNextElement())
				{
					...
					?>
						...
						<div class="element">
							<a href="/percoMobile/products/<?=$arFields["CODE"];?>.php#<?=$url["query"]?>">
				...
				if ($section["CODE"] == "identifikatory")
				{
					?>
						...
						<div class="element">
							<a href="/percoMobile/products/karty-dostupa/">
		...
		if ($arResult["ELEMENTS"]){
			...
			?>
				<div class="section" id="<?=$element["CODE"]?>" data-cat="<?=$element["CODE"]?>">
					<div class="element">
						<a href="/percoMobile/products/<?=$element["CODE"];?>.php">
