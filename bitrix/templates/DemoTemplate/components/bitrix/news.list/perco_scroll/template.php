...
array_splice($arResult["ITEMS"], 25);
if (LANGUAGE_ID != "ru")
{
...
?>
	<li data-src="<?=$arElement["PROPERTIES"]["FULL"]["VALUE"];?>" data-sub-html="<?=$arElement["PROPERTIES"]["FULL_OPIS"]["VALUE"][$keyFullPreview];?>">
		<div>
			<div class="anons_img">
				<img src="<?=$arElement["PROPERTIES"]["SCROLL"]["VALUE"];?>" alt="<?=$arElement["PROPERTIES"]["SCROLL_OPIS"]["VALUE"][$keyScrollOpis];?>" />
			</div>
			<div class="caption"><?=$arElement["PROPERTIES"]["SCROLL_OPIS"]["VALUE"][$keyScrollOpis] . $add_scroll;?></div>
		</div>
	</li>
<? }?>
</ul>