...
$MESS["LEARNING_MAIN_SEARCH_SEARCH"] = "Намери:";
$MESS["SEARCH_GO"] = "Търси";
$MESS["SEARCH_ERROR"] = "Във фразата за търсене е намерена грешка:";
$MESS["SEARCH_CORRECT_AND_CONTINUE"] = "Поправете фразата за търсенето и повторете отново.";
...
$MESS["SEARCH_MODIFIED"] = "Модифицирано:";
$MESS["SEARCH_NOTHING_TO_FOUND"] = "За съжаление, по вашата заявка за търсене, нищо не е намерено.";
$MESS["SEARCH_PATH"] = "Път:";
$MESS["SEARCH_SORT_BY_RANK"] = "Подреди по значимост";
$MESS["SEARCH_SORTED_BY_DATE"] = "Подредено по дата";
$MESS["SEARCH_SORTED_BY_RANK"] = "Подредено по значимост";
$MESS["SEARCH_SORT_BY_DATE"] = "Подреди по дата";
?>