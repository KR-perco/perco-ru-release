...
if ((<?php echo $arResult["currentMonth"]?> == 4) && (<?php echo $arResult["currentYear"]?> == 2022)) { 
	var divweekrow = document.querySelector(".week-row:nth-child(6) .seminars .event:nth-child(2)");
	console.log(divweekrow); 
	// divweekrow.innerHTML = '<div id="infowwww" class="viewEvents"><span class="spanBlock"><div style="width: 100%;" class="seminarvucentre"><b class="head_b"> Семинар в очном формате <ul> <li>«Обзор систем и оборудования PERCo»</li> <li>«Практические навыки по работе в системах PERCo»</li> <li>«Получение практических навыков в работе с системой PERCo-Web»</li> <li>«Сертификация «Авторизованный администратор»»</li> </ul> </b></div></span></div>';
	
	// divweekrow.innerHTML = '<div style="width: 100%;" class="seminarvucentre"><p style="line-height: 21px; padding: 0 0 0 5px; margin: 0px; font-weight: 600;  display:block; cursor: pointer;"> Вебинар </p></div>' 
