...
if (!sizeof($errors)) {
	...
	elseif ($bPostAnswer)
	{
		...
		if (strlen($_REQUEST["finish"])>0)
		{
			...
			//if (isset($_FILES)) $vote=1; else $vote=2;
			//LocalRedirect($arResult["REDIRECT_PAGE"].'&test='.$pr);
