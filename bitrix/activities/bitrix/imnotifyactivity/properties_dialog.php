...
<tr>
	...
	<td width="60%">
		...
		{
			?>
			<input type="text" name="to_user_id" id="id_to_user_id" value="<?= htmlspecialchars($arCurrentValues["to_user_id"]) ?>" size="50">
...
<tr>
	...
	<td width="60%">
		<input type="text" name="from_user_id" id="id_from_user_id" value="<?= htmlspecialchars($arCurrentValues["from_user_id"]) ?>" size="50">
...
<tr>
	...
	<td width="60%">
		<textarea name="message_site" id="id_message_site" rows="4" cols="40"><?= htmlspecialchars($arCurrentValues["message_site"]) ?></textarea>
...
<tr>
	...
	<td width="60%">
		<textarea name="message_out" id="id_message_out" rows="4" cols="40"><?= htmlspecialchars($arCurrentValues["message_out"]) ?></textarea>
